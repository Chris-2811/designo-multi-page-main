...
function HeroHome() {
  return (
    <section className=" md:container relative">
      <div className="absolute top-[320px] -left-[165px] rotate-180 -z-10">
        <Rectangle />
      </div>
      <div className="bg-peach relative text-center pt-20 px-6 md:px-10 lg:pt-[8.75rem] overflow-hidden md:rounded-[15px] lg:flex lg:text-left items-start lg:px-[6rem] lg:h-[640px]">
        ...
        <div className="relative w-full h-[465px] -mt-20 lg:-mt-40 flex justify-center">
          <img
            src={heroImage}
            alt="mobile-phone"
            className=" absolute top-0 min-w-[500px] h-[800px] lg:h-[875px] mx-auto left-[50%] lg:left-[65%] -translate-x-[50%] lg:object-cover"
          />
        </div>
      </div>
    </section>
